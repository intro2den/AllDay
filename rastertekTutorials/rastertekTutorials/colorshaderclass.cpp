...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd){
	...
	result = InitializeShader(device, hwnd, "../rastertekTutorials/color.vs", "../rastertekTutorials/color.ps");
	if (!result){
		return false;
	}
...
// NOTE: Tutorial used WCHAR* instead of CHAR*, however there were some type issues, using CHAR* seeems to have resolved them
