...
public:
	StaticTextClass();
	StaticTextClass(const StaticTextClass&);
	~StaticTextClass();
	...
	bool AddStaticText(int, int, char*, float, float, float, int, ID3D11Device*, ID3D11DeviceContext*);
...
protected:
	...
	std::list <SentenceType*> m_StaticSentences;
};
