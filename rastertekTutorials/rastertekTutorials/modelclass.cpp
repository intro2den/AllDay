...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	///////////////////////////////////
	// NOTE: This is currently partially hardcoded to draw a square and texture it
	///////////////////////////////////
	...
	//vertices[0].color = D3DXVECOTR4(0.0f, 1.0f, 0.0f, 1.0f);
	vertices[0].texture = D3DXVECTOR2(0.0f, 1.0f);

	vertices[1].position = D3DXVECTOR3(-1.0f, 1.0f, 0.0f);  // Top left.
	//vertices[1].color = D3DXVECOTR4(0.0f, 1.0f, 0.0f, 1.0f);
	vertices[1].texture = D3DXVECTOR2(0.0f, 0.0f);

	vertices[2].position = D3DXVECTOR3(1.0f, -1.0f, 0.0f);  // Bottom right.
	//vertices[2].color = D3DXVECOTR4(0.0f, 1.0f, 0.0f, 1.0f);
