...
bool SpriteClass::Initialize(ID3D11Device* device, int screenWidth, int screenHeight, CHAR* textureFilename, int bitmapWidth, int bitmapHeight){
	bool result;
...
bool SpriteClass::Render(ID3D11DeviceContext* deviceContext, int positionX, int positionY, int spriteID){
	bool result;

	// Re-build the dynamic vertex buffer for rendering to possibly a different location on the screen.
	result = UpdateBuffers(deviceContext, positionX, positionY, spriteID);
	if (!result){
		return false;
	}
...
bool SpriteClass::UpdateBuffers(ID3D11DeviceContext* deviceContext, int positionX, int positionY, int spriteID){
